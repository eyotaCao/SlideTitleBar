...
public class PxTool {
    ...
    public static int dpToPx(Context context,float value) {
        return dip2px(context,(int) value);//(int)(widthRate*value);
    }
    ...
    public static void setMeasureMax(View view){   //测量出最大尺寸
        view.measure(View.MeasureSpec.makeMeasureSpec(PxTool.dpToPx(view.getContext(),1000), View.MeasureSpec.AT_MOST),
                View.MeasureSpec.makeMeasureSpec(PxTool.dpToPx(view.getContext(),1000), View.MeasureSpec.AT_MOST));
    }
